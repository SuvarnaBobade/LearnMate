...
<form action="editprofile" method="post">
    <div class="container">
        ...
        <div class="profile-details">
            ...
            <div>
                 <label for="mo_number">Mobile Number:</label>
   				 <input type="text" name="mobile_no" value="${mobile_no}" readonly>
    		</div>

            <div>
                <label for="aadhar_no">Aadhar No:</label>
                <input type="text" name="aadhar_no" value="${aadhar_no} " readonly>
            </div>
            ...
            <div>
                ...
                <input type="number" name="passing_year" value="${passing_year}" readonly>
            </div>
        ...
        <div class="btn-container">
            <button type="button" class="edit-btn" onclick="window.location.href='index.html'">Log Out</button>
            <button type="button" class="edit-btn" onclick="window.location.href='confirmpass.html'">Update</button>
            <button type="button" class="edit-btn" onclick="window.location.href='ConfermEmailidhtml.html'">Delete</button>
